...
10. [`09-billing-boundary.md`](09-billing-boundary.md) — the planned $19 Unlimited offer and the server-owned billing boundary required before checkout or paid activation exists.
11. [`agents/`](agents/) — the mission, ownership, tasks, and acceptance criteria for each agent.
