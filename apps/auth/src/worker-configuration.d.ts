/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc src/worker-configuration.d.ts` (hash: 0939ebcda3b1a2e3a0f5e00b83dbbbde)
...
interface __BaseEnv_Env {
	...
	HUMAN_ASSERTION_ISSUER: "https://wandering-camel-662.convex.site";
	CONVEX_INTERNAL_SITE_URL: "https://wandering-camel-662.convex.site";
	BETTER_AUTH_RESOURCE_CLIENT_ID: "dongo-mcp-resource-dev";
	DONGO_API_RESOURCE_CLIENT_ID: "dongo-api-resource-dev";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUTH_FROM_EMAIL" | "PUBLIC_ORIGIN" | "AUTH_ISSUER" | "HUMAN_ASSERTION_ISSUER" | "CONVEX_INTERNAL_SITE_URL" | "BETTER_AUTH_RESOURCE_CLIENT_ID" | "DONGO_API_RESOURCE_CLIENT_ID" | "CIMD_ALLOWED_HOST_SUFFIXES" | "ENVIRONMENT">> {}
}
