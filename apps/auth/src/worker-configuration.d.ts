/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc src/worker-configuration.d.ts` (hash: 681ebf204edbfa65252dfcf8947c1adf)
// Runtime types generated with workerd@1.20260828.1 2026-08-30 nodejs_compat
interface __BaseEnv_Env {
	AUTH_DB: D1Database;
	EMAIL: SendEmail;
	AUTH_FROM_EMAIL: "auth@dongo.so" | "auth@dev.dongo.so";
	PUBLIC_ORIGIN: "https://dongo.so" | "https://dev.dongo.so";
	AUTH_ISSUER: "https://dongo.so/api/auth" | "https://dev.dongo.so/api/auth";
	HUMAN_ASSERTION_ISSUER: "https://brainy-camel-172.convex.site" | "https://wandering-camel-662.convex.site";
	CONVEX_INTERNAL_SITE_URL: "https://brainy-camel-172.convex.site" | "https://wandering-camel-662.convex.site";
	BETTER_AUTH_RESOURCE_CLIENT_ID: "dongo-mcp-resource-production" | "dongo-mcp-resource-dev";
	DONGO_API_RESOURCE_CLIENT_ID: "dongo-api-resource-production" | "dongo-api-resource-dev";
	CIMD_ALLOWED_HOST_SUFFIXES: "openai.com,chatgpt.com,anthropic.com,claude.ai";
...
declare namespace Cloudflare {
	...
	interface ProductionEnv {
		...
		AUTH_ISSUER: "https://dongo.so/api/auth";
		HUMAN_ASSERTION_ISSUER: "https://brainy-camel-172.convex.site";
		CONVEX_INTERNAL_SITE_URL: "https://brainy-camel-172.convex.site";
		BETTER_AUTH_RESOURCE_CLIENT_ID: "dongo-mcp-resource-production";
		DONGO_API_RESOURCE_CLIENT_ID: "dongo-api-resource-production";
		CIMD_ALLOWED_HOST_SUFFIXES: "openai.com,chatgpt.com,anthropic.com,claude.ai";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUTH_FROM_EMAIL" | "PUBLIC_ORIGIN" | "AUTH_ISSUER" | "HUMAN_ASSERTION_ISSUER" | "CONVEX_INTERNAL_SITE_URL" | "BETTER_AUTH_RESOURCE_CLIENT_ID" | "DONGO_API_RESOURCE_CLIENT_ID" | "CIMD_ALLOWED_HOST_SUFFIXES" | "ENVIRONMENT" | "BETTER_AUTH_SECRET" | "HUMAN_ASSERTION_SECRET" | "DONGO_INTERNAL_GATEWAY_SECRET" | "BETTER_AUTH_RESOURCE_CLIENT_SECRET" | "DONGO_API_RESOURCE_CLIENT_SECRET">> {}
}
