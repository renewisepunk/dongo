...
export const DONGO_SHORTCUTS: readonly DongoShortcut[] = [
  ...
  { id: "next", keys: ["J", "↓"], label: "Next", description: "Select the next item on Overview." },
  { id: "previous", keys: ["K", "↑"], label: "Previous", description: "Select the previous item on Overview." },
