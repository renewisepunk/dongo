/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc src/worker-configuration.d.ts` (hash: ef6ef930fb6f2a925e2384dea3f17c57)
...
interface __BaseEnv_Env {
	...
	RESEND_FROM_EMAIL: "notifications@dongo.so" | "notifications@dev.dongo.so";
	RESEND_FROM_NAME: "dongo";
	REQUIRED_NOTIFICATION_PROVIDERS: "resend";
	DONGO_APNS_CONFIG: "disabled" | string;
	DONGO_FCM_CONFIG: "disabled" | string;
...
declare namespace Cloudflare {
	...
	interface ProductionEnv {
		...
		RESEND_FROM_EMAIL: "notifications@dongo.so";
		RESEND_FROM_NAME: "dongo";
		REQUIRED_NOTIFICATION_PROVIDERS: "resend";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_HOSTNAMES" | "PUBLIC_ORIGIN" | "RESEND_FROM_EMAIL" | "RESEND_FROM_NAME" | "REQUIRED_NOTIFICATION_PROVIDERS" | "DONGO_APNS_CONFIG" | "DONGO_FCM_CONFIG" | "DONGO_NOTIFICATION_DISPATCH_SECRET" | "DONGO_RESEND_CONFIG">> {}
}
