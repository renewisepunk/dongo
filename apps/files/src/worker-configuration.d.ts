/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc src/worker-configuration.d.ts` (hash: 856448375fe1326b604e8f9e44aaab21)
// Runtime types generated with workerd@1.20260828.1 2026-08-30 nodejs_compat
interface __BaseEnv_Env {
	ATTACHMENTS: R2Bucket;
	FILES_RATE_LIMITER: RateLimit;
	PUBLIC_ORIGIN: "https://dongo.so" | "https://dev.dongo.so";
	ALLOWED_BROWSER_ORIGIN: "https://dongo.so" | "https://dev.dongo.so";
	CONVEX_SITE_URL: "https://brainy-camel-172.convex.site" | "https://wandering-camel-662.convex.site";
	DONGO_ATTACHMENT_URL_SIGNING_SECRET?: string;
...
declare namespace Cloudflare {
	...
	interface ProductionEnv {
		...
		ALLOWED_BROWSER_ORIGIN: "https://dongo.so";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_ORIGIN" | "ALLOWED_BROWSER_ORIGIN" | "CONVEX_SITE_URL" | "DONGO_ATTACHMENT_URL_SIGNING_SECRET" | "DONGO_INTERNAL_GATEWAY_SECRET">> {}
}
