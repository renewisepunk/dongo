/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc src/worker-configuration.d.ts` (hash: 491a9802e26e587b8b9af66a69b09833)
// Runtime types generated with workerd@1.20260828.1 2026-08-30 nodejs_compat
interface __BaseEnv_Env {
	MCP_RATE_LIMITER: RateLimit;
	PUBLIC_ORIGIN: "https://dongo.so" | "https://dev.dongo.so";
	ALLOWED_HOSTNAMES: "dongo.so" | "dev.dongo.so";
	ALLOWED_ORIGIN_HOSTNAMES: "dongo.so" | "dev.dongo.so";
	AUTHORIZATION_SERVER_ISSUER: "https://dongo.so/api/auth" | "https://dev.dongo.so/api/auth";
	AUTHORIZATION_SERVER_METADATA_JSON: "{\"client_id_metadata_document_supported\":true,\"scopes_supported\":[\"dongo:work:read\",\"dongo:work:write\",\"dongo:attachments:read\",\"offline_access\"],\"issuer\":\"https://dongo.so/api/auth\",\"authorization_endpoint\":\"https://dongo.so/api/auth/oauth2/authorize\",\"token_endpoint\":\"https://dongo.so/api/auth/oauth2/token\",\"registration_endpoint\":\"https://dongo.so/api/auth/oauth2/register\",\"introspection_endpoint\":\"https://dongo.so/api/auth/oauth2/introspect\",\"revocation_endpoint\":\"https://dongo.so/api/auth/oauth2/revoke\",\"response_types_supported\":[\"code\"],\"grant_types_supported\":[\"authorization_code\",\"refresh_token\",\"urn:ietf:params:oauth:grant-type:device_code\"],\"code_challenge_methods_supported\":[\"S256\"],\"device_authorization_endpoint\":\"https://dongo.so/api/auth/device/code\"}" | "{\"client_id_metadata_document_supported\":true,\"scopes_supported\":[\"dongo:work:read\",\"dongo:work:write\",\"dongo:attachments:read\",\"offline_access\"],\"issuer\":\"https://dev.dongo.so/api/auth\",\"authorization_endpoint\":\"https://dev.dongo.so/api/auth/oauth2/authorize\",\"token_endpoint\":\"https://dev.dongo.so/api/auth/oauth2/token\",\"registration_endpoint\":\"https://dev.dongo.so/api/auth/oauth2/register\",\"introspection_endpoint\":\"https://dev.dongo.so/api/auth/oauth2/introspect\",\"revocation_endpoint\":\"https://dev.dongo.so/api/auth/oauth2/revoke\",\"response_types_supported\":[\"code\"],\"grant_types_supported\":[\"authorization_code\",\"refresh_token\",\"urn:ietf:params:oauth:grant-type:device_code\"],\"code_challenge_methods_supported\":[\"S256\"],\"device_authorization_endpoint\":\"https://dev.dongo.so/api/auth/device/code\"}";
	BETTER_AUTH_INTROSPECTION_URL: "https://dongo.so/api/auth/oauth2/introspect" | "https://dev.dongo.so/api/auth/oauth2/introspect";
	BETTER_AUTH_RESOURCE_CLIENT_ID: "dongo-mcp-resource-production" | "dongo-mcp-resource-dev";
	CONVEX_SITE_URL: "https://brainy-camel-172.convex.site" | "https://wandering-camel-662.convex.site";
	SERVICE_DOCUMENTATION_URL: "https://dongo.so/help" | "https://dev.dongo.so/help";
	BETTER_AUTH_RESOURCE_CLIENT_SECRET?: string;
	DONGO_INTERNAL_GATEWAY_SECRET?: string;
	AUTH_SERVICE: Fetcher /* dongo-auth-production */ | Fetcher /* dongo-auth-dev */;
}
declare namespace Cloudflare {
	...
	interface ProductionEnv {
		...
		ALLOWED_HOSTNAMES: "dongo.so";
		ALLOWED_ORIGIN_HOSTNAMES: "dongo.so";
		AUTHORIZATION_SERVER_ISSUER: "https://dongo.so/api/auth";
		AUTHORIZATION_SERVER_METADATA_JSON: "{\"client_id_metadata_document_supported\":true,\"scopes_supported\":[\"dongo:work:read\",\"dongo:work:write\",\"dongo:attachments:read\",\"offline_access\"],\"issuer\":\"https://dongo.so/api/auth\",\"authorization_endpoint\":\"https://dongo.so/api/auth/oauth2/authorize\",\"token_endpoint\":\"https://dongo.so/api/auth/oauth2/token\",\"registration_endpoint\":\"https://dongo.so/api/auth/oauth2/register\",\"introspection_endpoint\":\"https://dongo.so/api/auth/oauth2/introspect\",\"revocation_endpoint\":\"https://dongo.so/api/auth/oauth2/revoke\",\"response_types_supported\":[\"code\"],\"grant_types_supported\":[\"authorization_code\",\"refresh_token\",\"urn:ietf:params:oauth:grant-type:device_code\"],\"code_challenge_methods_supported\":[\"S256\"],\"device_authorization_endpoint\":\"https://dongo.so/api/auth/device/code\"}";
		BETTER_AUTH_INTROSPECTION_URL: "https://dongo.so/api/auth/oauth2/introspect";
		BETTER_AUTH_RESOURCE_CLIENT_ID: "dongo-mcp-resource-production";
		CONVEX_SITE_URL: "https://brainy-camel-172.convex.site";
		SERVICE_DOCUMENTATION_URL: "https://dongo.so/help";
		BETTER_AUTH_RESOURCE_CLIENT_SECRET: string;
		DONGO_INTERNAL_GATEWAY_SECRET: string;
		AUTH_SERVICE: Fetcher /* dongo-auth-production */;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_ORIGIN" | "ALLOWED_HOSTNAMES" | "ALLOWED_ORIGIN_HOSTNAMES" | "AUTHORIZATION_SERVER_ISSUER" | "AUTHORIZATION_SERVER_METADATA_JSON" | "BETTER_AUTH_INTROSPECTION_URL" | "BETTER_AUTH_RESOURCE_CLIENT_ID" | "CONVEX_SITE_URL" | "SERVICE_DOCUMENTATION_URL" | "BETTER_AUTH_RESOURCE_CLIENT_SECRET" | "DONGO_INTERNAL_GATEWAY_SECRET">> {}
}
