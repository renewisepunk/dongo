/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc src/worker-configuration.d.ts` (hash: b3c659e9e186ecf22e7a0f862a06c4ea)
...
interface __BaseEnv_Env {
	...
	ALLOWED_ORIGIN_HOSTNAMES: "dev.dongo.so";
	AUTHORIZATION_SERVER_ISSUER: "https://dev.dongo.so/api/auth";
	BETTER_AUTH_INTROSPECTION_URL: "https://dev.dongo.so/api/auth/oauth2/introspect";
	BETTER_AUTH_RESOURCE_CLIENT_ID: "dongo-mcp-resource-dev";
	CONVEX_SITE_URL: "https://wandering-camel-662.convex.site";
	AUTH_SERVICE: Fetcher /* dongo-auth-dev */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_ORIGIN" | "ALLOWED_HOSTNAMES" | "ALLOWED_ORIGIN_HOSTNAMES" | "AUTHORIZATION_SERVER_ISSUER" | "BETTER_AUTH_INTROSPECTION_URL" | "BETTER_AUTH_RESOURCE_CLIENT_ID" | "CONVEX_SITE_URL">> {}
}
