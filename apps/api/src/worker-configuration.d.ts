/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc src/worker-configuration.d.ts` (hash: d6664fd348b08d6a303da590d2544931)
// Runtime types generated with workerd@1.20260828.1 2026-08-30 nodejs_compat
interface __BaseEnv_Env {
	API_RATE_LIMITER: RateLimit;
	API_RESOURCE: "https://dev.dongo.so/api/agent/v1";
	...
	BETTER_AUTH_RESOURCE_CLIENT_ID: "dongo-api-resource-dev";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "API_RESOURCE" | "ALLOWED_HOSTNAMES" | "AUTHORIZATION_SERVER_ISSUER" | "BETTER_AUTH_INTROSPECTION_URL" | "BETTER_AUTH_RESOURCE_CLIENT_ID" | "CONVEX_SITE_URL">> {}
}
