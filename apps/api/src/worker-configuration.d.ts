/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc src/worker-configuration.d.ts` (hash: 01457722c3e5a626dff2d0f078a517f4)
// Runtime types generated with workerd@1.20260828.1 2026-08-30 nodejs_compat
interface __BaseEnv_Env {
	API_RATE_LIMITER: RateLimit;
	API_RESOURCE: "https://dongo.so/api/agent/v1" | "https://dev.dongo.so/api/agent/v1";
	...
	BETTER_AUTH_RESOURCE_CLIENT_ID: "dongo-api-resource-production" | "dongo-api-resource-dev";
...
declare namespace Cloudflare {
	...
	interface ProductionEnv {
		API_RATE_LIMITER: RateLimit;
		API_RESOURCE: "https://dongo.so/api/agent/v1";
		...
		BETTER_AUTH_RESOURCE_CLIENT_ID: "dongo-api-resource-production";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "API_RESOURCE" | "ALLOWED_HOSTNAMES" | "AUTHORIZATION_SERVER_ISSUER" | "BETTER_AUTH_INTROSPECTION_URL" | "BETTER_AUTH_RESOURCE_CLIENT_ID" | "CONVEX_SITE_URL" | "BETTER_AUTH_RESOURCE_CLIENT_SECRET" | "DONGO_INTERNAL_GATEWAY_SECRET">> {}
}
