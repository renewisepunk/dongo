...
| Web product behavior | Proven in automated browser matrix | 213 Playwright tests pass across Chromium, Firefox, and WebKit, including Overview, detail, responsive states, paste image, full-page drop, upload retry/cancel, search, settings, help, keyboard shortcuts, capture-boundary navigation, and auth/consent states. | Perform the live media and golden human/agent journeys, plus manual screen-reader, high-zoom, and performance review on the release candidate. |
