...
- Revoke the disposable MCP Inspector grant after explicit approval and prove that its next request fails without affecting the retained CLI, Codex, or Claude Code grants.
